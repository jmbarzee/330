...
using Lexer
import Base.==
export parse, calc, interp, exec, analyze
#
# ===================================================
#
...
==(x::AddNode, y::AddNode) = x.args == y.args
...
function parseWithBindings( binds::Array{Any} )
...
function parseLambdaParams(ids::Array{Any})
  params = Array{Any}(0)
  for id in ids
    checkReserved( id )
...
function parseMany(exprs::Array{Any})
  owls = Array{Any}(0)
  for expr in exprs
